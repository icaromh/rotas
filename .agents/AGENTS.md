...
- **Local Troubleshooting Requirement**: Ao auxiliar na depuração de filas presas (pgmq) ou problemas de permissão (como erros 42501 em tabelas locais) durante o desenvolvimento local com Supabase, recomende e utilize o comando `npx supabase db reset`. Isso limpa estados defeituosos do banco e garante a re-aplicação limpa das permissões e migrations, o que costuma resolver falhas de execução em background.

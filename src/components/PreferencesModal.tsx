        ...
        <div className="flex flex-col gap-6">
          <div className="flex flex-col gap-2">
            <label className="text-sm font-bold text-gray-800 flex justify-between">
              {t('preferences.routeBuffer')}
              <span id="buffer-value-display" className="text-[#4a6b46]">{bufferMeters}{t('preferences.meters')}</span>
            </label>
            <p className="text-xs text-gray-500 leading-relaxed mb-1">{t('preferences.bufferHelp')}</p>
            <input 
              type="range" 
              id="buffer-slider" 
              min="0" max="100" 
            ...
            <div className="flex justify-between text-[10px] text-gray-400 font-medium">
              <span>0{t('preferences.meters')}</span>
              <span>100{t('preferences.meters')}</span>
            </div>
          </div>
